...
## materiale
**(update)**
freemysqlhosting.net er kun gratis i 3 dage. Følgende tutorial viser hvordan i kan oprette og bruge "ClearDB" som jeres online tilgængelige database, i forbindelse med hosting på Heroku.
