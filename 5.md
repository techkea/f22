...
* Indgå i et gruppesamarbejde omkring et softwareprojekt ved brug af Centralized Workflow metoden eller . 
* Clone et github repository og Clone dets branches
...
* [Git Book (8.1)](https://git-scm.com/book/en/v2/Customizing-Git-Git-Configuration)
...
Lav en klon af dette fags githubrepository. Det er det der ligger bagved denne side: https://techkea.github.io/f22/    

```` 
	git clone https://github.com/techkea/f22.git

````
Kig lidt rundt i filerne og dan dig et overblik. Læg mærke til hvordan de hænger sammen med https://techkea.github.io/f22/ siden.
(5.md svarer feks. til denne side: https://techkea.github.io/f22/5.html)  
